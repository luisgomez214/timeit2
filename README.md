...
| ---------------------- | ---------------- | ---------------- | --------------------- |
| `check_palindrome_1`   |4.12 msec per loop|4.28 msec per loop|  57.2 msec per loop   | 
| `check_palindrome_2`   |5.21 msec per loop|5.39 msec per loop|5.08 msec per loop     |
